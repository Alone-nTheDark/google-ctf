...
pub fn new(state: &mut State, vdp: &mut TargetVdp, singleton: bool, keep_loaded: bool) ->  BigSprite {
    BigSprite::new(state, vdp, /*tiles_idx=*/TILES_IDX, /*w=*/{{width}}, /*h=*/{{height}}, SPRITES, ANIMS, singleton, keep_loaded)
}
