...
<tileset version="1.10" tiledversion="1.10.2" name="player-flamesword" tilewidth="64" tileheight="72" tilecount="8" columns="4">
 <image source="player-flamesword.png" width="256" height="144"/>
 <tile id="0">
  <properties>
