...
<tileset version="1.10" tiledversion="1.10.2" name="player-strongsword" tilewidth="64" tileheight="72" tilecount="8" columns="4">
 <image source="player-strongsword.png" width="256" height="144"/>
 <tile id="0">
  <properties>
